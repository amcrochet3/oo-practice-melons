...
def print_pairing_info(melon_types):
    ...
    for melon in melon_types:
        print(f"{melon.name} pairs nicely with:")
...
class Melon:
    ...
    def __init__(
            self, type, shape_rating, color_rating, field_number, harvester
    ):
...
def get_sellability_report(melons):
    ...
    for melon in melons:
        ...
        print(f"Harvested by {melon.harvester} from Field {melon.field_number} {status}")
